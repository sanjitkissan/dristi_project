...
export default function HeroSection() {
  return (
    <section className='w-full main-container flex flex-col lg:flex-row items-center justify-between gap-6  my-24'>
      <div className='w-full h-80 flex flex-col items-start justify-start gap-4 p-8 rounded-md shadow-[0_3px_10px_rgb(0,0,0,0.2)]'>
      ...
      <div className='w-full h-80 rounded-md overflow-hidden shadow-[0_3px_10px_rgb(0,0,0,0.2)]'>
