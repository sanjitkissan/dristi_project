...
<section className='absolute top-0 bottom-0 right-0 left-0  bg-black bg-opacity-80'>
    <div className=' main-container w-full h-full flex flex-col items-center justify-center gap-4'>
        ...
        <h1 className='text-5xl  text-white font-bold capitalize'>help your business to get on a new stage</h1>
        <p className=' w-1/2 text-base text-white text-center '>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Minima recusandae sit amet non veniam dolore minus tempore cum placeat quo.</p>
