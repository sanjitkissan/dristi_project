...
export default function OurNews() {
  return (
    <section className='w-full main-container flex items-center justify-between gap-4 my-24'>
      <div className='w-1/3 flex flex-col h-96 items-start justify-between '> 
